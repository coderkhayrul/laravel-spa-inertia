            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-6">
                    <label
                        ...
                        :class="{
                            ...
                            'text-red-700: form-errors.name': form.errors.name,
                        }"
                        >Product name</label
                    >
                    <input
                        ...
                        v-model="form.name"
                        id="name"
                        class="shadow-sm bg-gray-50 border text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                        :class="{
                            'border-gray-300 text-red-900': !form.errors.name,
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input
                        ...
                        class="shadow-sm bg-gray-50 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                        :class="{
                            'border-gray-300 text-red-900': !form.errors.price,
                            'border-red-500 bg-red-50 text-red-900':
                                form.errors.price,
                        }"
                    />
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input
                        ...
                        class="shadow-sm bg-gray-50 border text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                        :class="{
                            'border-gray-300 text-red-900': !form.errors.weight,
                            'border-red-500 bg-red-50 text-red-900':
                                form.errors.weight,
                        }"
                    />
